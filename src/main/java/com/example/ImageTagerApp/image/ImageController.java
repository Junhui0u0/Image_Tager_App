...
public class ImageController {
    ...
    public ResponseEntity<ResultResponse> registerImages(@RequestHeader(value="userDeviceToken") String userDeviceToken, @RequestPart("images") List<MultipartFile> images
            , @RequestPart("fileUriList") List<String> fileUriList) throws JsonProcessingException {
    ...
    public ResponseEntity<ResultResponse> registerImagesByRandomTag(@RequestHeader(value="userDeviceToken") String userDeviceToken, @RequestPart("images") List<MultipartFile> images, @RequestPart("fileUriList") List<String> fileUriList) throws JsonProcessingException {
